...
<head>
    ...
    <title>Keterangan Lahir- Brand</title>
        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Form Surat Keterangan Lahir</h2>
                    <p></p>
                </div>
                <form method="POST" enctype="multipart/form-data" id="FormEmail">
                            <div class="form-group"><label for="name">Email</label>
                        <input class="form-control" name="email" id="email" type="text"></div>
                        <div class="form-group"><label for="name">Nama</label>
                       <input class="form-control" name="name" placeholder="Nama Anak Yang lahir" type="text"></div>
                            <div class="form-group"><label for="name">Tanggal Lahir (Hari-Bulan-Tahun )</label>
                        <input class="form-control" name="tanggal"  type="text"></div>
                       <div class="form-group">
                        <label for="name">Surat Pengantar RT</label>
                        <input class="form-control-file" name="SRT" type="file"></div>
                    <div class="form-group">
                        <label for="name">Surat Pengantar RW</label>
                        <input class="form-control-file" name="SRW" type="file"></div>
                    <div class="form-group"><label for="name">Foto Suami</label>
                        <input class="form-control-file" name="SMI" type="file" ></div>
                         <div class="form-group"><label for="name">Foto Istri</label>
                        <input class="form-control-file" name="istri" type="file" ></div>
                    <div class="form-group"><label for="name">Foto Kartu Keluarga</label>
                        <input class="form-control-file" name="KK" type="file"></div>
                    <div class="form-group"><label for="name">Surat Nikah&nbsp;</label>
                        <input class="form-control-file" name="SN" type="file"></div>
                    <div class="form-group"><label for="name">Surat Keterangan Lahir</label>
                        <input class="form-control-file" name="SKL" type="file"></div>
