        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Form Izin mendirikan bangunan</h2>
                    <p></p>
                </div>
                <form method="POST" enctype="multipart/form-data" id="FormEmail">
                    ...
                    <div class="form-group"><label for="name">KTP</label>
                        <input class="form-control-file" name="KTP" type="file"></div>
                    <div class="form-group"><label for="name">Surat pengantar desa</label>
                        <input class="form-control-file" name="SPD" type="file"></div>
                    <div class="form-group"><label for="name">Gambar sketsa rumah</label>
                        <input class="form-control-file"  name="GBS" type="file"></div>

                    <div class="form-group"><label for="name">Foto Surat tanah</label>
                        <input class="form-control-file" name="ST" type="file"></div>
                    <div class="form-group"><label for="name">Bukti pelunasan PBB tahun berjalan</label>
                        <input class="form-control-file" name="PBB" type="file"></div>
