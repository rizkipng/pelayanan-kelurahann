...
<head>
    ...
    <title>Surat Kematian - Brand</title>
        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Form Surat Kematian</h2>
                    <p></p>
                </div>
                <form method="POST" enctype="multipart/form-data" id="FormEmail">
                    ...
                    <div class="form-group"><label for="name">Surat Pengantar RT</label>
                        <input class="form-control-file" name="SRT" type="file" required=""></div>
                    <div class="form-group"><label for="name">Surat Pengantar RW</label>
                        <input class="form-control-file" name="SRW" type="file" required=""></div>
                    <div class="form-group"><label for="name">Foto&nbsp; Kartu Keluarga</label>
                        <input class="form-control-file" name="KK" type="file" required=""></div>
                    <div class="form-group"><label for="name">Foto KTP</label>
                        <input class="form-control-file" name="KTP" type="file" required=""></div>
                    <div class="form-group"><label for="name">Surat Keterangan Kematian</label>
                        <input class="form-control-file" name="SKK" type="file"></div>
                    <div class="form-group"><label for="name">Surat Pernyataan Ahli Waris</label>
                        <input class="form-control-file" name="SPA" type="file" required=""></div>
