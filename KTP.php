...
<head>
    ...
    <title>Kartu Tanda Penduduk- Brand</title>
        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Form KTP</h2>
                    <p></p>
                </div>
                <form method ='POST' enctype="multipart/form-data" id="FormEmail">
                    <div class="form-group"><label for="name">Email</label>
                        ...
                        <div class="form-group"><label for="name">Nama Lengkap</label>
                            <input class="form-control" name="name" id="name" type="text"></div>
                              <div class="form-group"><label for="name">Tanggal Lahir</label>
                        <input class="form-control" name="usia" id="usia" type="text"></div>
                                
                    <div class="form-group"><label for="name">Tempat Lahir</label>
                        <input class="form-control" name="tml" type="text"></div>
                    
                    <div class="form-group"><label for="name">Alamat</label>
                        <input class="form-control" name="almt" type="text"></div>
                    ...
                    <div class="form-group"><label for="name">Pekerjaan</label>
                        <input class="form-control" name="pkj" type="text"></div>
                    ...
                    <div class="form-group"><label for="name">Surat Pengantar RT</label>
                        <input class="form-control-file" name="SRT" id="SRT" type="file" ></div>
                    <div class="form-group"><label for="name">Surat Pengantar RW</label>
                        <input class="form-control-file"  name="SRW" id="SRW" type="file" ></div>
                    <div class="form-group"><label for="name">Foto&nbsp; Kartu Keluarga</label>
                        <input class="form-control-file" name="KK" id="KK" type="file" ></div>
                    <div class="form-group"><label for="name">Foto akta kelahiran</label>
                        <input class="form-control-file" name="akta" id="akta" type="file" ></div>
                    <div class="form-group"><label for="name">Surat Nikah (Jika Sudah menikah)</label>
                            <input class="form-control-file" name="SN" id="SN" type="file">
                    </div>
